...
int64_t kt_Baseline9(params_t *params, vault_t *vault);
...
int64_t kt_twopass(params_t *params, vault_t *vault);
...
void stream(params_t *params, vault_t *vault, char* edgesFile, char* outputLocation);
